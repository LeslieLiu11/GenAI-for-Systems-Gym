...
from cache_replacement.policy_learning.cache_model import model_sigmoid
...
def main(_):
  ...
  policy_model = model_sigmoid.EvictionPolicyModel.from_config(model_config).to(device)
